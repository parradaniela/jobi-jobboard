    ...
    <aside className="pt-12 flex flex-col justify-between text-white wrapper xl:flex-row">
      ...
      <ul className="flex justify-center gap-4 xl:justify-between">
        <li className='transition-all hover:opacity-70 focus-within:opacity-70'>
          <a href="/">
            <img src={logoFacebook} alt="Visit our Facebook page" title="Visit our Facebook page" />
          </a>
        </li>
        <li className='transition-all hover:opacity-70 focus-within:opacity-70'>
          <a href="/">
            <img src={logoInstagram} alt="Visit our Instagram page" title="Visit our Instagram page" />
          </a>
        </li>
        <li className='transition-all hover:opacity-70 focus-within:opacity-70'>
          <a href="/">
            <img src={logoPinterest} alt="Visit our Pinterest page" title="Visit our Pinterest page" />
          </a>
        </li>
      </ul>
    </aside>
