    ...
    <form action="submit" className="w-full text-center mt-4 md:w-2/3 xl:mt-0 xl:w-auto xl:text-left">
        ...
        <fieldset>
            ...
            <div className="bg-white/5 z-0 p-2 my-2 md:flex">
                ...
                <button className="bg-white/20 p-2 text-xs rounded w-full md:basis-1/4 transition-all hover:bg-jobi-green-lime/100 hover:text-jobi-green-dark focus:bg-jobi-green-lime/100 focus:text-jobi-green-dark">Send</button>
            </div>
